...
import com.mycompany.mavenproject1.nullhandler.DefaultValue;
...
import com.mycompany.mavenproject1.nullhandler.IFillNullFields;
...
public class MailManager implements IFillNullFields<MailManager> {
    ...
    public class Builder {
        ...
        public MailManager build() {
            fillNullFields(MailManager.this);
